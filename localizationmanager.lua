Hooks:Add("LocalizationManagerPostInit", "locfixes", function(loc)
	LocalizationManager:add_localized_strings({
		...
		bm_wp_r870_s_solid = "Standard Stock (r870)", --locomotive has both of these and they have the same name
		bm_wp_m4_s_standard = "Standard Stock (m4)",
		bm_wp_m4_m_straight = "Vintage Mag", --remove . at the end
		...
		plt_a06a_any_03 = "I'm there in one minute.", --mallcrasher bile line
		pln_nightclub_stage1_09_any_01 = "Guys, you need to get this safe open.", --fix later
		pln_nightclub_stage1_10_any_01 = "Yes, that's the stuff! There we go.", --fix later
