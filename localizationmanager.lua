Hooks:Add("LocalizationManagerPostInit", "locfixes", function(loc)
	LocalizationManager:add_localized_strings({
		...
		hud_int_equipment_barcode_downtown = "Barcode: Downtown", --consistency, the board thing doesnt have washington at the end
		...
		bm_wp_r870_s_solid = "Standard Stock (r870)", --locomotive has both of these and they have the same name, i want to figure out something i could add to one of them without renaming the weapon mod entirely as thats not good
		...
		pln_watchdogs_new_stage1_02_any_01 = "Hey, there's too many cops out there! Get yourself ready to deal with them when the doors open.", --fix later
		pln_watchdogs_new_stage1_10_any_02 = "OK people, the pick-up driver is here! He's on the street behind you!", --driver not drive
		pln_watchdogs_new_stage1_18_any_03 = "Escape driver's coming in now. The escape driver is coming in now!", --fix later
