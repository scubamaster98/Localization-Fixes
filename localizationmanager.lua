Hooks:Add("LocalizationManagerPostInit", "locfixes", function(loc)
	LocalizationManager:add_localized_strings({
		menu_chat_peer_kicked = "$name; has been kicked.", -- have been kicked
		menu_chat_peer_lost = "$name; lost connection.", -- disconnected is too vague and similar to left the game imo
		menu_asset_safe_escape = "Expert Driver", -- Expert Driver .
		...
		dr1_a67_any_01 = " ", -- watchdogs day 1 car death line
		dr1_a67_any_02 = " ", -- same as last
		dr1_a67_any_03 = " ", -- same as last
		dr1_a67_any_04 = " ", -- same as last
